import './தொடர்பு_கூறு.css';
import React, { useState, useEffect, useRef } from 'react';

import { ref, get } from 'firebase/database';
import { db } from '../../நூலகம்/ஃபயர்பேஸ்/வாடிக்கையாளர்';
import { addLike, removeLike, addComment, deleteComment, updateComment, subscribeToEngagement } from '../../நூலகம்/தொடர்பு';
import { auth } from '../../நூலகம்/ஃபயர்பேஸ்/வாடிக்கையாளர்';
import { onAuthStateChanged, signInAnonymously } from 'firebase/auth';
import { ConfirmDialog } from '../பின்னூட்டம்/உறுதிப்படுத்தல்';
