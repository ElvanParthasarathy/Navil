...
import { subscribe, getCachedRaw } from '../../../நூலகம்/ஃபயர்பேஸ்/தேக்ககம்';
import AdBanner from '../../../கூறுகள்/ஊடகம்/விளம்பரம்';
import { getOptimizedImage } from '../../../நூலகம்/ஊடகம்';
import { Engagement } from '../../../கூறுகள்/தொடர்பு/தொடர்பு_கூறு';
...
<AdBanner variant="inline" wrapperStyle={{ margin: '60px 0' }} />
            ...
            <style>{`
                ...
                @keyframes slideFromRight { from { opacity: 0; transform: translateX(36px); } to { opacity: 1; transform: translateX(0); } } @media (min-width: 769px) { @keyframes slideFromRight { from { opacity: 0; } to { opacity: 1; } } }
                .slideFromRight {
                    animation: slideFromRight 0.4s cubic-bezier(0.16, 1, 0.3, 1) forwards;
                }

                @keyframes slideFromLeft { from { opacity: 0; transform: translateX(-36px); } to { opacity: 1; transform: translateX(0); } } @media (min-width: 769px) { @keyframes slideFromLeft { from { opacity: 0; } to { opacity: 1; } } }
                .slideFromLeft {
