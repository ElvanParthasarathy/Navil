...
const GradientCustomizer = () => {
    const [isOpen, setIsOpen] = React.useState(() => {
        return localStorage.getItem('sidebar_customizer_open') === 'true';
    });
    ...
    const toggleCustomizer = () => {
        ...
        setIsOpen(nextState);
        localStorage.setItem('sidebar_customizer_open', String(nextState));
    };
...
[data-theme='dark'] .sidebar {
  box-shadow: ${shadowX}px 0 ${shadowBlur}px ${shadowSpread}px rgba(0, 0, 0, ${shadowOpacity});
    ...
    const handleCopy = () => {
        ...
        alert("Awesome! Gradient and Blur values copied to clipboard! Tell Antigravity these values now!");
    };
            ...
            {!isOpen ? (
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2px' }}>
                        <span style={{ fontWeight: 'bold', fontSize: '13px' }}>🎨 Sidebar Gradient & Blur Tool</span>
                        <button 
                            onClick={toggleCustomizer}
                    ...
                    <div style={{ borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '10px' }}>
                        <div style={{ fontSize: '11px', color: '#00ff66', fontWeight: 'bold', marginBottom: '8px', letterSpacing: '0.5px' }}>📍 BACKDROP BLUR PLACEMENT</div>
                    ...
                    {/* GRADIENT COLORS */}
                    <div style={{ borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '10px' }}>
                        <div style={{ fontSize: '11px', color: '#ff00ff', fontWeight: 'bold', marginBottom: '8px', letterSpacing: '0.5px' }}>🎨 BACKGROUND GRADIENT</div>
                        
                        <div style={{ display: 'flex', gap: '8px', marginBottom: '8px' }}>
                            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '3px' }}>
                                <span style={{ fontSize: '9px', color: '#aaa' }}>START COLOR</span>
                                <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
                                    <input type="color" value={startColor} onChange={(e) => setStartColor(e.target.value)} style={{ width: '22px', height: '22px', border: 'none', cursor: 'pointer', background: 'none' }} />
                                    <input type="text" value={startColor} onChange={(e) => setStartColor(e.target.value)} style={{ width: '100%', background: '#121214', border: '1px solid #333', color: '#fff', padding: '3px', borderRadius: '4px', fontSize: '10px' }} />
                                </div>
                            </div>
                            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '3px' }}>
                                <span style={{ fontSize: '9px', color: '#aaa' }}>END COLOR</span>
                                <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
                                    <input type="color" value={endColor} onChange={(e) => setEndColor(e.target.value)} style={{ width: '22px', height: '22px', border: 'none', cursor: 'pointer', background: 'none' }} />
                                    <input type="text" value={endColor} onChange={(e) => setEndColor(e.target.value)} style={{ width: '100%', background: '#121214', border: '1px solid #333', color: '#fff', padding: '3px', borderRadius: '4px', fontSize: '10px' }} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
                            ...
                            <input type="range" min="0" max="360" value={angle} onChange={(e) => setAngle(Number(e.target.value))} style={{ width: '100%', accentColor: '#ff00ff', cursor: 'pointer' }} />
                        </div>
                    </div>

                    {/* SHADOW CONTROLS */}
                    <div>
                        <div style={{ fontSize: '11px', color: '#60EFFF', fontWeight: 'bold', marginBottom: '8px', letterSpacing: '0.5px' }}>👥 BOX SHADOW DEPTH</div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '3px', marginBottom: '6px' }}>
                            ...
                            <input type="range" min="-80" max="80" value={shadowX} onChange={(e) => setShadowX(Number(e.target.value))} style={{ width: '100%', accentColor: '#60EFFF', cursor: 'pointer' }} />
                        </div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '3px', marginBottom: '6px' }}>
                            ...
                            <input type="range" min="10" max="150" value={shadowBlur} onChange={(e) => setShadowBlur(Number(e.target.value))} style={{ width: '100%', accentColor: '#60EFFF', cursor: 'pointer' }} />
                        </div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '3px', marginBottom: '6px' }}>
                            ...
                            <input type="range" min="-30" max="80" value={shadowSpread} onChange={(e) => setShadowSpread(Number(e.target.value))} style={{ width: '100%', accentColor: '#60EFFF', cursor: 'pointer' }} />
                        </div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
                            ...
                            <input type="range" min="0" max="1" step="0.05" value={shadowOpacity} onChange={(e) => setShadowOpacity(Number(e.target.value))} style={{ width: '100%', accentColor: '#60EFFF', cursor: 'pointer' }} />
                        </div>
                    </div>

                    {/* Code Display */}
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                        <label style={{ fontSize: '8px', color: '#777', fontWeight: 600 }}>CURRENT CSS</label>
                        <textarea 
                            readOnly 
                            value={cssString} 
                            style={{ background: '#121214', border: '1px solid #333', color: '#00ff66', padding: '6px', borderRadius: '6px', fontSize: '9px', fontFamily: 'monospace', height: '90px', resize: 'none', outline: 'none' }}
                        />
                    </div>
