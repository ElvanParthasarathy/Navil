...
import { db, auth } from '../நூலகம்/ஃபயர்பேஸ்/வாடிக்கையாளர்';
...
import { SCHEMAS, SharedDatalists, DEFAULT_AUTHORS, formatTimestampToLegacy } from '../கூறுகள்/கையாளுநர்/பொதுவானவை/கையாளுநர்பொது';
import { generateSlug, getBestTitle, textToHtml, resolveAuthorForPair, cleanForStorage } from '../கூறுகள்/கையாளுநர்/பொதுவானவை/கையாளுநர்பயன்பாடுகள்';
import { ProfileEditor } from '../கூறுகள்/கையாளுநர்/தொகுப்பான்கள்/தன்னுருதொகுப்பான்';
import { AboutEditor } from '../கூறுகள்/கையாளுநர்/தொகுப்பான்கள்/பற்றிதொகுப்பான்';
import { PoemEditor } from '../கூறுகள்/கையாளுநர்/தொகுப்பான்கள்/செய்யுள்தொகுப்பான்';
import { QuoteEditor } from '../கூறுகள்/கையாளுநர்/தொகுப்பான்கள்/நவில்மொழிதொகுப்பான்';
import { BlogEditor } from '../கூறுகள்/கையாளுநர்/தொகுப்பான்கள்/வலைப்பதிவுதொகுப்பான்';
import { ArticleEditor } from '../கூறுகள்/கையாளுநர்/தொகுப்பான்கள்/கட்டுரைதொகுப்பான்';
import { StoryEditor } from '../கூறுகள்/கையாளுநர்/தொகுப்பான்கள்/கதைதொகுப்பான்';
import { DiaryEditor } from '../கூறுகள்/கையாளுநர்/தொகுப்பான்கள்/நாட்குறிப்புதொகுப்பான்';
import { ArtEditor } from '../கூறுகள்/கையாளுநர்/தொகுப்பான்கள்/கலைதொகுப்பான்';
import NirvaagiLogin from '../கூறுகள்/கையாளுநர்/முகப்புப்பலகை/கையாளுநர்நுழைவு';
import CommentsManager from '../கூறுகள்/கையாளுநர்/முகப்புப்பலகை/கருத்துகள்மேலாளர்';
import NirvaagiDashboard from '../கூறுகள்/கையாளுநர்/முகப்புப்பலகை/கையாளுநர்முகப்புப்பலகை';
import BookMakerView from '../கூறுகள்/கையாளுநர்/பார்வைகள்/நூல்உருவாக்கும்பார்வை';
import { addComment } from '../நூலகம்/தொடர்பு';

import '../வடிவமைப்பு/கையாளுநர்விதானம்.css';

// Import Data (Initial State for non-Supabase data)
import initialProfile from '../தரவு/தன்னுரு.json';
